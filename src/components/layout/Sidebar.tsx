    ...
    <div className={`h-screen flex-shrink-0 ${mobile ? 'w-64' : 'w-16 md:w-24'} bg-primary dark:bg-gray-800 ${mobile ? '' : 'rounded-r-3xl'} flex flex-col items-center py-6 transition-colors duration-200`}>
      ...
      <nav className="flex flex-col items-center space-y-8 flex-1">
        ...
        >
          ...
          {mobile && <span className="ml-3">Home</span>}
        </Link>
        ...
        >
          ...
          {mobile && <span className="ml-3">Calendar</span>}
        </Link>
        ...
        >
          ...
          {mobile && <span className="ml-3">Gallery</span>}
        </Link>
        ...
        >
          ...
          {mobile && <span className="ml-3">Map</span>}
        </Link>
        ...
        >
          ...
          {mobile && <span className="ml-3">Profile</span>}
        </Link>
      </nav>
      ...
      <div className="mt-auto">
        ...
        >
          ...
          {mobile && <span className="ml-3">Logout</span>}
        </Link>
      </div>
    </div>
  );
