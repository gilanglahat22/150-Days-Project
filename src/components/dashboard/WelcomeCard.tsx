...
const WelcomeCard: React.FC<WelcomeCardProps> = ({
  ...
  return (
    <div className="bg-orange-100 dark:bg-orange-900 rounded-2xl p-6 mb-6 relative overflow-hidden">
      <div className="flex flex-col max-w-[60%]">
        <h2 className="text-xl font-semibold mb-1 text-gray-800 dark:text-white">Hello, {username}!</h2>
        ...
        <div className="space-y-2">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm text-gray-600 dark:text-gray-300">Outdoor temperature</span>
          </div>
